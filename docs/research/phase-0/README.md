...
OQ-006 is resolved through [USER-DECISION-OQ006-001](./evidence/OQ-006/USER-DECISION-RECEIPT-001.md)
and [ADR-0016](../../adr/0016-schema-lineage-and-projection-ownership.md), and OQ-007 is
resolved through [USER-DECISION-OQ007-001](./evidence/OQ-007/USER-DECISION-RECEIPT-001.md)
and [ADR-0017](../../adr/0017-versioned-semantic-digest.md). OQ-013 remains a decision-ready
recommendation without a decision receipt:
...
| OQ-007 | [OQ-007-digest-canonicalization.md](./OQ-007-digest-canonicalization.md) | [FX-IDENTITY-SCHEMA-DIGEST-CONFIG-001/README.md](./fixtures/FX-IDENTITY-SCHEMA-DIGEST-CONFIG-001/README.md) | [RUN-OQ007-001/RUN.md](./evidence/OQ-007/FX-IDENTITY-SCHEMA-DIGEST-CONFIG-001/RUN-OQ007-001/RUN.md); [RUN-OQ007-002/RUN.md](./evidence/OQ-007/FX-IDENTITY-SCHEMA-DIGEST-CONFIG-001/RUN-OQ007-002/RUN.md); [USER-DECISION-OQ007-001](./evidence/OQ-007/USER-DECISION-RECEIPT-001.md) | resolved / [ADR-0017](../../adr/0017-versioned-semantic-digest.md) Accepted |
...
OQ-011 remains a decision-ready retention and bootstrap packet without a decision receipt:
...
state/risk/size retention candidates. OQ-010's C-01 profile was adopted with recurrence `2`,
eligible unassisted success `3` and minimum age `7 days`; OQ-011's retention/bootstrap values
remain candidate observations. Its bootstrap result distinguishes `UNINITIALIZED`, `EMPTY`,
`AVAILABLE` and `UNAVAILABLE` rather than collapsing missing or corrupt memory into an empty
query. The fixture and receipt still do not choose production event/SQLite schema, a production
bootstrap Gate, retention worker or any product implementation.
...
OQ-005 was subsequently resolved through ADR-0015 and its delegated decision receipt, OQ-009
through its crash-point matrix, delegated decision receipt and ADR-0014, and OQ-010 through its
delegated decision receipt and ADR-0018.
