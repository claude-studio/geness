...
- `python3 -m json.tool docs/research/phase-0/evidence/OQ-013/FX-IDENTITY-SCHEMA-DIGEST-CONFIG-001/RUN-OQ013-001/result.json >/dev/null` → exit `0`
...
OQ-013 remains pending user decision. No ADR, product schema, config policy or
