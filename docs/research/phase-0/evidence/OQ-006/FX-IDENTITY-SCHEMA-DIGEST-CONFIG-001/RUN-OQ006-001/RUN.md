...
- `python3 -m json.tool docs/research/phase-0/evidence/OQ-006/FX-IDENTITY-SCHEMA-DIGEST-CONFIG-001/RUN-OQ006-001/result.json >/dev/null` → exit `0`
