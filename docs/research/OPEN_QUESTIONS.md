...
| OQ-010 | lesson fingerprint, 승격, 감쇠와 만료 threshold는 무엇인가? | C-01 deterministic evaluator; independent recurrence `2`, eligible unassisted success `3`, minimum age `7 days` | delegated user authority | [ADR-0018](../adr/0018-deterministic-lesson-evaluator.md) |
...
| RQ-014 | C-01: structured fingerprint는 독립 run 2회 또는 reproducible guard evidence에서 `verified` 후보가 되고, candidate/probationary는 eligible unassisted success 3회와 최소 age 7일을 충족해야 `expired` 후보가 된다. 일반 retrieval은 `verified|enforced`만 노출한다. | [ADR-0018](../adr/0018-deterministic-lesson-evaluator.md), [OQ-010 receipt](./phase-0/evidence/OQ-010/USER-DECISION-RECEIPT-001.md) |
...
Accepted ADR-0017으로, OQ-010은 RQ-014 delegated receipt와 Accepted ADR-0018으로 Resolved로 기록했다. OQ-015는 앞선
packet의 cross-concern synthesis owner이며 RQ-005 receipt로 C-01 boundary를 Resolved로
기록했다. 이 결정들은 OQ-008 및 OQ-011/OQ-012/OQ-013/OQ-014의 user decision을 대체하지 않는다. 특히 일반
