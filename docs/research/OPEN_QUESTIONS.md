...
| OQ-010 | lesson fingerprint, 승격, 감쇠와 만료 threshold는 무엇인가? | C-01 deterministic evidence-gated evaluator; independent recurrence `2`, eligible unassisted success `3`, minimum age `7일` | delegated user authority | [ADR-0018](../adr/0018-deterministic-lesson-evaluator.md) |
...
| RQ-014 | C-01: lesson lifecycle은 deterministic evidence-gated evaluator를 사용하고, 독립 recurrence 2회 또는 reproducible guard evidence로 승격하며, eligible unassisted success 3회와 최소 관찰 기간 7일을 초기 expiry profile로 사용한다. | [ADR-0018](../adr/0018-deterministic-lesson-evaluator.md), [OQ-010 receipt](./phase-0/evidence/OQ-010/USER-DECISION-RECEIPT-001.md) |
...
Accepted ADR-0017으로, OQ-010은 RQ-014 delegated receipt와 Accepted ADR-0018로
Resolved로 기록했다. OQ-015는 앞선 packet의 cross-concern synthesis owner이며 RQ-005
receipt로 C-01 boundary를 Resolved로 기록했다. 이 결정들은 OQ-008 및
